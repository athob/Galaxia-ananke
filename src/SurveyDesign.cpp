...
void SurveyDesign::close()
{
	...
	cout<<left<<setw(36)<<"Total stars written "<<setw(24)<<nstars<<endl;
	{
		...
		stringstream sout;
		sout<<"# File generated by Galaxia_ananke "<<version()<<endl;
		sout<<"# Software available under the AGPL-3.0 license"<<endl;
		sout<<"# at https://github.com/athob/Galaxia-ananke."<<endl;
